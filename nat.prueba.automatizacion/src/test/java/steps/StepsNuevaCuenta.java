...
public class StepsNuevaCuenta {
	...
	PagesRegistro creacionCuenta = new PagesRegistro();
	Bases abrirBrowser = new Bases();
	...
	public void pagina_principal() throws InterruptedException {
		creacionCuenta.Login();

	}

	
	@When("^presiono create new account$")
	public void presiono_create_new_account() {
		creacionCuenta.paginaRegistro();

	}

	@Then("^presiono el icono de registro$")
	public void presiono_el_icono_de_registro() {
		creacionCuenta.botonesRegistro();
